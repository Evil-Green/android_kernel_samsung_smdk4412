...
static const unsigned int asv_voltage_4212[CPUFREQ_LEVEL_END][12] = {
	...
	{  925000,  912500,  900000,  887500,  887500,  887500,	 875000,  875000,  875000,  862500,  862500,  850000 }, /* L15 */
};

static const unsigned int asv_voltage_s[CPUFREQ_LEVEL_END] = {
	1300000, 1300000, 1300000, 1250000, 1200000, 1175000, 1100000,
	1050000, 1025000, 1000000, 1000000, 1000000, 950000, 950000, 900000
};

/* ASV table for 12.5mV step */
static const unsigned int asv_voltage_step_12_5[CPUFREQ_LEVEL_END][12] = {
	/*   ASV0,    ASV1,    ASV2,    ASV3,	 ASV4,	  ASV5,	   ASV6,    ASV7,    ASV8,    ASV9,   ASV10,   ASV11 */
	{ 1400000, 1400000, 1400000, 1400000, 1387500, 1387500, 1375000, 1362500, 1350000, 1337500, 1325000, 1312500 }, /* L0 */
	{ 1387500, 1375000, 1362500, 1350000, 1337500, 1325000, 1312500, 1300000, 1287500, 1275000, 1262500, 1250000 }, /* L1 */
...
static const unsigned int asv_voltage_step_12_5_rev2[CPUFREQ_LEVEL_END][13] = {
	...
	{  912500,  900000,  900000,  900000,  887500,  875000,  875000,  875000,  875000,  875000,  862500,  862500,  862500 },	/* L15 */
};
...
static const unsigned int asv_voltage_step_1ghz[CPUFREQ_LEVEL_END][12] = {
	...
	{  962500,  962500,  962500,  962500,  924500,  924500,	 924500,  912500,  912500,  912500,  912500,  875500 },
};
